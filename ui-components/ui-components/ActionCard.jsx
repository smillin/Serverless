...
export default function ActionCard(props) {
  const { Productui, overrides, ...rest } = props;
  const buttonOnClick = useNavigateAction({
    type: "url",
    url: `${"/create-checkout-session"}${"?"}${Productui?.name}`,
  });
  return (
    <Flex
      gap="0"
      ...
      >
        ...
        >
          ...
          <Text
            ...
            padding="0px 0px 0px 0px"
            whiteSpace="pre-wrap"
            children={Productui?.description}
